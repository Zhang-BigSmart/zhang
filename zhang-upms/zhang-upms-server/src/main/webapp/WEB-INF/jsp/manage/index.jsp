...
<head>
	...
	<link href="${basePath}/resources/zhang-admin/plugins/bootstrap-3.3.0/css/bootstrap.min.css" rel="stylesheet"/>
	<link href="${basePath}/resources/zhang-admin/plugins/material-design-iconic-font-2.2.0/css/material-design-iconic-font.min.css" rel="stylesheet"/>
	<link href="${basePath}/resources/zhang-admin/plugins/waves-0.7.5/waves.min.css" rel="stylesheet"/>
	<link href="${basePath}/resources/zhang-admin/plugins/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.min.css" rel="stylesheet"/>
	<link href="${basePath}/resources/zhang-admin/css/admin.css" rel="stylesheet"/>
	<style>
		/** skins **/
	...
	<ul id="menu">
		...
		<li id="logo" class="hidden-xs">
			<a href="${basePath}/manage/index">
				<img src="${basePath}/resources/zhang-admin/images/logo.png"/>
			</a>
...
<section id="main">
	...
	<aside id="sidebar">
		...
		<div class="s-profile">
			...
			<ul id="personal" class="main-menu">
				<li>
					<a class="waves-effect" @click="personInfor" href="javascript:;"><i class="zmdi zmdi-account"></i> 个人资料</a>
				</li>
				<li>
					<a class="waves-effect" href="javascript:;"><i class="zmdi zmdi-face"></i> 隐私管理</a>
				</li>
...
<script src="${basePath}/resources/zhang-admin/plugins/jquery.1.12.4.min.js"></script>
<script src="${basePath}/resources/zhang-admin/plugins/bootstrap-3.3.0/js/bootstrap.min.js"></script>
<script src="${basePath}/resources/zhang-admin/plugins/waves-0.7.5/waves.min.js"></script>
<script src="${basePath}/resources/zhang-admin/plugins/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js"></script>
<script src="${basePath}/resources/zhang-admin/plugins/BootstrapMenu.min.js"></script>
<script src="${basePath}/resources/zhang-admin/plugins/device.min.js"></script>
<script src="${basePath}/resources/zhang-admin/plugins/jquery.cookie.js"></script>
<script src="${basePath}/resources/zhang-admin/js/admin.js"></script>
<script src="${basePath}/resources/zhang-admin/plugins/fullPage/jquery.fullPage.min.js"></script>
<script src="${basePath}/resources/zhang-admin/plugins/fullPage/jquery.jdirk.min.js"></script>
<script src="${basePath}/resources/zhang-admin/plugins/vue/vue.js"></script>
</body>
</html>